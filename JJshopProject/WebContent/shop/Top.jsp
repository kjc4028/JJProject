...
<div class="container">
	<div class="carousel-inner">
            <div class="item active" >
               <img src="images/12.jpg" style="height: 500px; width: 1500px;">
            </div>
            </div>
...
<%					} %>
   ...
   <%}%>
		...
		<c:if test="${pageMaker.prev }">
			<a href="top.shop?pageNum=${pageMaker.startPage-1 }&perPageNum=9">&laquo;</a>
				</c:if>
				
				<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">	
						<c:if test="${pageMaker.cri.page == idx }" >
		<a href="top.shop?pageNum=${idx }&perPageNum=9">[${idx }]</a>
		</c:if>
		<c:if test="${pageMaker.cri.page != idx }" >
		<a href="top.shop?pageNum=${idx }&perPageNum=9">${idx }</a>
			</c:if>
			...
			<a href="top.shop?pageNum=${pageMaker.endPage+1 }&perPageNum=9">&raquo;</a>
				</c:if>
			</div>
</body>
</html>